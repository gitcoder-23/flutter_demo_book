...
Color deepBlue = const Color(0xff1061ed);
...
Color textcolor = const Color(0xff12B264);
...
Color greenshadow = const Color(0xffD4FFEA);
Color darkpurple = const Color(0xff473F97);
Color pinkcolor = const Color(0xff4361EE);
Color skyblueshadow = const Color(0xffD4F5FF);
Color arrowcolor = const Color(0xff8EC4AA);
Color pinkshadow = const Color(0xffFFD4D4);
Color boxcolor = const Color(0xffE8EAEC);
Color boxshadow = const Color(0xffE8EAEC);
Color yellowtext = const Color(0xffB98757);
